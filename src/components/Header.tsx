    ...
    <>
      ...
      <header
        ...
        className={`fixed left-0 right-0 z-50 transition-all duration-300 h-[58px] lg:h-[68px] top-[24px] lg:top-[26px] ${
          isScrolled
            ? 'bg-[#F5E9DD]/90 backdrop-blur-md border-b border-[#6E6A66]/10 shadow-sm'
            : 'bg-[#F5E9DD] border-b border-[#6E6A66]/10 shadow-sm'
        }`}
      >
        <div className="max-w-7xl mx-auto px-[18px] md:px-12 h-full flex items-center justify-between">
          ...
          <div className="hidden lg:block my-0 py-0">
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 bg-[#AB907B] hover:bg-[#424139] text-white font-sans text-[11px] uppercase tracking-widest font-semibold h-[40px] px-[22px] rounded-none transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-[#AB907B] shadow-sm hover:shadow-md leading-none my-0"
            >
          ...
          >
              ...
              <nav className="flex flex-col gap-4">
                {navLinks.map((link, idx) => (
                  <motion.a
                    ...
                    className="font-sans text-xl font-medium text-[#6E6A66] hover:text-[#AB907B] py-2 border-b border-[#6E6A66]/10"
                  >
                    {link.label}
                  </motion.a>
                ))}
            ...
            <div className="flex flex-col gap-6">
              <button
                ...
                className="w-full text-center bg-[#AB907B] hover:bg-[#424139] text-white font-sans text-sm uppercase tracking-widest font-semibold py-4 px-6 rounded-none transition-colors"
              >
                Fale com um consultor
              </button>
              
              <div className="text-center">
                <p className="font-sans text-xs text-[#6E6A66]/80">
